...
load_dotenv(os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'tvt3_v2', '.env'))
...
def run_mfd_import_poll(target_date: str = None):
    ...
    try:
        ...
        if scrape_result.get('error'):
            ...
            if raw_data:
                from generator.mfd_import_v2 import import_mfd_data, update_incomplete_records
